...
def remove_sides(img):
    ...
    cv.rectangle(img,(0,0),shape,(0,0,0),30)
...
def find(cor):
    ...
    attack = img
    helth = img
    attack = img[cor[1] + 100:cor[1] + 180, cor[0] + -10:cor[0] + 90]
    helth = img[cor[1] + 100:cor[1] + 180, cor[0] + 70:cor[0] + 160]
    ...
    cv.imwrite(r'C:\Users\Jerome\OneDrive\Desktop\SAP_AI\recogniton_files\attack.png',attack)
    cv.imwrite(r'C:\Users\Jerome\OneDrive\Desktop\SAP_AI\recogniton_files\helth.png',helth)
